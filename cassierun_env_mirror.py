...
# -*- encoding: utf-8 -*-
'''
@File    :   cassierun_env_mirror.py
@Time    :   2023/04/07 11:11:16
@Author  :   Hu Bin 
@Version :   1.0
@Desc    :   None
'''
...
if __name__ == "__main__":
    ...
    aa = CassieRunMirrorEnv(env_fn, mirrored_obs=env_fn().mirrored_obs, mirrored_act=env_fn().mirrored_acts)
